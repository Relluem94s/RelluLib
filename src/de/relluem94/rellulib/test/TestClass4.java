...
public class TestClass4{
	...
	public static void threadTest(){
		...
		tm.startTread(tm.addThread(new ThreadWorker(){@Override public void run(){sleep(2000); LogUtils.info("Test22");}}));
		tm.startTread(tm.addThread(new ThreadWorker(){@Override public void run(){sleep(3000); LogUtils.info("Test44");}}));
		tm.startTread(tm.addThread(new ThreadWorker(){@Override public void run(){sleep(4000); LogUtils.info("Test66");}}));
